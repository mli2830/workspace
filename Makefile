...
dushoff_github = techtex-ebola sherif makestuff TZ_clinics Latent_incidence_fitting scratch
...
mli_github = Survival mylife lunchbox rdc mikenimble cancer_survival nimble_test HLPM Li_Rabies mli_sims HIV_Coupling factorialtemplate wzmli.github.com
$(mli_github):
